...
<template>
  <div class="example-section">
    <h2>Component Gallery (A2UISurface)</h2>
    <p class="example-description">
      Renders <code>component-gallery.json</code> through
      <code>A2UISurface</code>, exercising every default-catalog component:
      Row, Column, List, Card, Image, Icon, Video, AudioPlayer, Text, Button,
      Divider, ChoicePicker, TextField, DateTimeInput, CheckBox, Slider, Tabs
      and Modal.
    </p>
